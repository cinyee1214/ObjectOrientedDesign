...
public class Hotel {
    ...
    private static HashMap<String, List<Hotel>> hotelNames;
    private static HashMap<String, List<Hotel>> hotelLocations;
    private static HashMap<String, List<Hotel>> hotelRankings;
    private static HashMap<String, List<Hotel>> hotelCosts;
    ...
    public static HashMap<String, List<Hotel>> getHotelLocations() {
        return hotelLocations;
    }

    public static HashMap<String, List<Hotel>> getHotelRankings() {
        return hotelRankings;
    }

    public static HashMap<String, List<Hotel>> getHotelCosts() {
        return hotelCosts;
    }

    public static HashMap<String, List<Hotel>> getHotelNames() {
        return hotelNames;
    }
